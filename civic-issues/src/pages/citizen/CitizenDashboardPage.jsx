    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <DashboardStatsCard
          ...
          count={reportsData.totalReports || 0}
          label="Total Reports"
          color="blue"
        />
        ...
        <DashboardStatsCard
          ...
          count={reportsData.submittedReports || 0}
        ...
        <DashboardStatsCard
          ...
          count={reportsData.resolvedReports || 0}
        ...
        <DashboardStatsCard
          ...
          count={emergenciesData.totalEmergencies || 0}
          label="Emergencies"
          color="red"
        />
      </div>
