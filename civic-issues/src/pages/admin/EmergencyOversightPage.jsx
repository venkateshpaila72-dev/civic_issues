...
import { getAllEmergencies } from '../../api/services/adminService';
...
const EmergencyOversightPage = () => {
  ...
  return (
    <PageContainer
      title="Emergency Oversight"
      subtitle={`${emergencies.length} total emergenc${emergencies.length !== 1 ? 'ies' : 'y'} across the system`}
    >
      {error && (
      ...
      {emergencies.length === 0 ? (
        <EmptyState
          ...
          message="All emergencies across the system will appear here"
        />
      ) : (
        <div className="space-y-4">
          {emergencies.map((emergency) => {
            ...
            return (
              <div key={emergency._id} className="card">
                <div className="flex items-start justify-between gap-4 mb-3">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-700 line-clamp-2">{emergency.description}</p>
                  </div>
                ...
                <div className="flex items-center gap-4 pt-3 border-t border-gray-100 text-sm">
                  <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <span>Citizen: {emergency.citizen?.fullName}</span>
                  </div>
                  ...
                  {emergency.respondingOfficer && (
                    <div className="flex items-center gap-2 text-blue-600">
                      ...
                      <span>Officer: {emergency.respondingOfficer.fullName}</span>
                    </div>
                  )}
                </div>
              </div>
...
export default EmergencyOversightPage;